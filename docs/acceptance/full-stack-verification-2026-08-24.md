...
审计日期：2026-08-24
最后同步：2026-08-25（取消 OPC 认证申请/审核并清理有效业务路径后）

审计范围：最终首页原型、正式产品路由、账号与业务写入、治理后台、测试、压测、本地运行、镜像、Terraform、发布与真实云环境。
...
3.2、3.3、4.2、5.2 中记录的主要代码缺口已经补齐：最终首页能够读取真实城市、动态、活动、成员、机构与个人数据，并调用真实加入城市、发帖、评论、互动、关注、报名、机构申请、资料和帮助工单动作；政策、个人记录、活动、管理后台也有正式 URL。权限、治理、媒体、通知、死信、注销和平台管理员初始化已经形成业务闭环及自动化用例。

OPC 认证申请/审核不属于当前产品范围，相关入口和业务读写已移除；历史迁移中的遗留表不主动删除，以避免破坏性数据变更。
...
- 机构申请、帮助工单和政策来源追溯已经开发；OPC 认证申请按产品决策取消。
...
1. 为机构申请、帮助工单、注销完成和死信操作增加独立集成/E2E。
